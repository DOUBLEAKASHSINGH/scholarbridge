      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div className="!bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
            ...
            <p className="!text-slate-700">To democratize access to education and career funding by leveraging artificial intelligence to automate opportunity discovery and application mentorship.</p>
          </div>
          <div className="!bg-white p-8 rounded-2xl shadow-sm border border-slate-100">
            <h3 className="text-xl font-bold !text-blue-600 mb-3">The Technology</h3>
            <p className="!text-slate-700">ScholarBridge acts as an autonomous engine. It actively scans the web, structures complex eligibility data, and provides students with a context-aware AI Coach to guide their applications.</p>
          </div>
        </div>
