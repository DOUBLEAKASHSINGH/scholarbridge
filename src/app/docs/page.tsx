export default function DocsPage() {
  return (
    <div className="max-w-3xl mx-auto py-20 px-6 prose prose-blue prose-slate">
      <h1 className="text-4xl font-bold text-slate-900 mb-4">Documentation</h1>
      <p className="text-lg text-slate-600 mb-12">Learn how to navigate and maximize the ScholarBridge platform.</p>
      
      <h2 className="text-2xl font-semibold text-slate-800 mt-8 mb-4 border-b pb-2">For Students</h2>
      ...
      <h2 className="text-2xl font-semibold text-slate-800 mt-8 mb-4 border-b pb-2">For Administrators</h2>
