        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li><Link href="/admin" className="text-sm text-slate-500 hover:text-blue-600 transition-colors">Admin Portal</Link></li>
            </ul>
            <div className="flex items-center gap-4">
              <a href="https://github.com/DOUBLEAKASHSINGH/scholarbridge" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-slate-900 transition-colors">
